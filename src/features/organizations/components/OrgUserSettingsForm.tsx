...
import { orgUserSettingsSchema } from "../actions/schema"
import { RatingIcons } from "@/features/jobListingsApplication/components/RatingIcons"
import { RATING_OPTIONS } from "../data/constants"
import { updateOrgUserSettings } from "../actions/organizationUserSettingsActions"

const ANY_VALUE = "any"

export function EmployerUserSettingsForm({
    userSettings,
}: {
    userSettings?: Pick<
    ...
    const form = useForm({
        resolver: zodResolver(orgUserSettingsSchema),
    ...
    async function onSubmit(
        data: z.infer<typeof orgUserSettingsSchema>
    ) {
        const result = await updateOrgUserSettings(data)
